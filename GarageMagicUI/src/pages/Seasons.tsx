...
export default function Seasons() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ── Active season card (standings ↔ manage toggle) ────────── */}
      {activeSeason ? (
        <Card>
          ...
          <div className="flex items-start justify-between gap-3 mb-3">
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              {user?.isAdmin && (
                ...
                >
                  {showAdminView ? '← Standings' : '✏️ Edit Season'}
                </button>
              )}
            </div>
          </div>
            ...
            {!showAdminView ? (
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  {editing ? (
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-gray-500 text-sm">Name, start and end dates.</p>
                ...
                <div className="border-t border-gray-800 pt-4 space-y-3">
                  <div>
                    <p className="text-gray-400 text-sm font-medium">Edit Standings</p>
                    <p className="text-gray-500 text-xs mt-1">Update or seed totals, then save all at once.</p>
                  </div>
                      ...
                      return (
                        <div key={`${row.userId || 'blank'}-${index}`} className="grid grid-cols-[minmax(0,2fr)_repeat(2,minmax(0,1fr))_auto] gap-2 items-center">
                          ...
                          <input type="number" min={0} step={1}
                            ...
                            placeholder="Losses"
                          />
                          <button type="button" onClick={() => removeRecordRow(index)}
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    ...
                    <button type="button" onClick={() => saveRecords(activeSeason.id)} disabled={savingRecords}
